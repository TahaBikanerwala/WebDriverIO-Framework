Feature: Dependent Sign up feature

Create Spring health member account for user who is Spouse or dependent of someone who is offered Spring Health by Organization

Background:
    Given User does not have Spring Health account 
    And   Is someone who is spouse or dependent of someone who is offered Spring Health by Organization 

 Scenario: As a valid dependent covered life, User wants to create Spring health member account for themselves
    When User takes manual verification 
    And  completes it successfully
    Then User is asked wether He wants to create account for himself and his child
    ...
    And  submits form 
    Then Member is asked to verify his mail
    When email verification is done
    Then User navigated to Personalize you details screen
   

 Scenario: As a valid dependent covered life, User wants to create Spring health member account for themselves and their child
    When User takes manual verification 
    And  completes it successfully
    Then User is asked wether He wants to create account for himself and his child
    ...
    Then Member is asked to verify his mail
    When email verification is done
    Then User is navigated to create child account screen
